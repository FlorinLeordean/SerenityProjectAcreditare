...
public class LoginTest extends BaseTest{
    ...
    public void validLoginTest(){
        ...
        loginSteps.verifyUsernameMessage("leordean2");
    }
    ...
    public void loginWithInvalidCredentials(){
        loginSteps.navigateToHomepage();
        loginSteps.navigateToLoginPage();
        loginSteps.setCredentials("leordean2@yahoo.com", "1234567");
        loginSteps.clickLoginButton();
        loginSteps.verifySignInErrorMessage("ERROR: The password you entered for the email address leordean2@yahoo.com is incorrect. Lost your password?");
    }
